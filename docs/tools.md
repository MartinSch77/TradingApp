...
| Squish Coco | Qt Group (froglogic), qt.io/product/quality-assurance/coco | at `/opt/SquishCoco` — **license expired**, unusable until renewed | MC/DC coverage + CocoAI test-case suggestion (documented alternative) |
